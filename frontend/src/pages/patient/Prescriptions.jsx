...
function downloadPrescriptionDocument(prescription, medications) {
  const blob = new Blob([buildPrescriptionHtml(prescription, medications)], {
    type: 'text/html;charset=utf-8',
  })
  const url = window.URL.createObjectURL(blob)
  const link = document.createElement('a')
  link.href = url
  link.download = `prescription-${String(prescription.id || 'download').slice(0, 8)}.html`
    ...
    <div className="patient-page-stack">
      <section className="patient-surface-card">
        ...
        <div className="patient-prescription-toolbar">
          <label className="patient-compact-field patient-prescription-search">
